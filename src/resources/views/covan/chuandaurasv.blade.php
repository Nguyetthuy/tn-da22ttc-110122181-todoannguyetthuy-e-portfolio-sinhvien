  ...
  <div class="content-header pt-4 pb-3">
    <div class="container-fluid">
      <div class="d-flex justify-content-between align-items-center flex-wrap">
        ...
        <form action="{{ route('covan.chuandaurasv.capnhat') }}" method="POST" class="mt-3 mt-md-0">
            @csrf
                            ...
                            <div class="mb-4">
                                <div class="plo-header p-3 px-md-4" data-toggle="collapse" data-target="#collapse{{ $loop->index }}">
                                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
                                        <div class="d-flex flex-column mb-2 mb-md-0 flex-grow-1 pr-3">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-shrink-0 mt-3 mt-md-0">
