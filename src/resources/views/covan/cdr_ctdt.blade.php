                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($mang2chieu as $kq=>$mang1chieu)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if(isset($mang1chieu[5]))
                                                            @if($mang1chieu[5] == 1)
                                                                <span>Đánh giá lần 1</span>
                                                            @elseif($mang1chieu[5] == 2)
                                                                <span>Đánh giá lần 2</span>
                                                            @elseif($mang1chieu[5] == 3)
                                                                <span>Đánh giá lần 3</span>
                                                            @elseif($mang1chieu[5] == 4)
                                                                <span>Đánh giá kết thúc môn</span>
                                                            @else
                                                                <span>Lần đánh giá khác (Mã: {{ $mang1chieu[5] }})</span>
                                                            @endif
                                                        @else
                                                            <i class="text-muted">Chưa phân loại</i>
                                                        @endif
                                                    </td>
