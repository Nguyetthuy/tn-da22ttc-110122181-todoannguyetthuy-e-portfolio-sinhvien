...
class KQ_CDRController extends Controller
{
    public function monhoc($maHocPhan, $maLop)
    {
        $maSSV = session('maSSV');
        ...
        foreach ($dshinh_thucDG as $dshtdg) {
            ...
            if ($maHTDG == 'T1') {
                ...
                $sqlRubric = "SELECT tieu_chi_rubric.maCDR_HP, cdr_hp.maCDR_HP_VB, cdr_hp.tenCDR_HP,
                    SUM(tieu_chi_rubric.trongSo) as Trongso, SUM(danh_gia_rubric.diem) as diem,
                    COUNT(tieu_chi_rubric.maTieuChiRubric) as soTieuChi
                    ...
                    AND phieu_cham.maPhieuCham = %d GROUP BY tieu_chi_rubric.maCDR_HP";

                if ($maLoaiDG == 4 && count($kqdsphieucham) >= 2) {
                    $kqR1 = DB::select(sprintf($sqlRubric, $kqdsphieucham[0]->maPhieuCham));
                    $kqR2 = DB::select(sprintf($sqlRubric, $kqdsphieucham[1]->maPhieuCham));
                    foreach ($kqR1 as $i => $r) {
                        if ($r->soTieuChi == 0) continue;
                        $d1 = $r->diem / $r->soTieuChi;
                        $d2 = isset($kqR2[$i]) ? $kqR2[$i]->diem / $kqR2[$i]->soTieuChi : 0;
                        $mang2chieu[$sodong][0] = $r->maCDR_HP;
                        $mang2chieu[$sodong][1] = $r->maCDR_HP_VB;
                        $mang2chieu[$sodong][2] = $r->tenCDR_HP;
                        $mang2chieu[$sodong][3] = ($d1 + $d2) / 2;
                    ...
                    foreach ($kq as $r) {
                        ...
                        $mang2chieu[$sodong][1] = $r->maCDR_HP_VB;
                        $mang2chieu[$sodong][2] = $r->tenCDR_HP;
                        $mang2chieu[$sodong][3] = $r->diem / $r->soTieuChi;
                        $mang2chieu[$sodong][4] = $trongSo;
                        $sodong++;
                    }
                }
...
//return $sql;
        if (count($kqdsphieucham) == 0) {
            ...
            return view('sinhvien.hocphan.kq_cdt_ctdt', [
                "hocPhan"    => $hocPhan_db,
 ...
 { 
    ...
    if(count($kqdsphieucham)>0)
    {
            ...
            || $dshtdg->maHTDG=='T18' || $dshtdg->maHTDG=='T19')
            {
                ...
                if ($dshtdg->maLoaiDG==4)//rubric kết thúc môn
                {
                    ...
                    $sql1="SELECT tieu_chi_rubric.maCDR_CTDT, cdr_ctdt.maCDR_CTDT_VB, cdr_ctdt.tenCDR_CTDT, sum(tieu_chi_rubric.trongSo) as 'Trongso',sum(danh_gia_rubric.diem) as 'diem',  COUNT(tieu_chi_rubric.maTieuChiRubric) as 'soTieuChi'
                    FROM cdr_ctdt, danh_gia_rubric, phieu_cham, tieu_chi_rubric, muc_do_cl
                    where danh_gia_rubric.maPhieuCham= phieu_cham.maPhieuCham 
                    and cdr_ctdt.maCDR_CTDT=tieu_chi_rubric.maCDR_CTDT
                    and danh_gia_rubric.maTieuChiRubric= tieu_chi_rubric.maTieuChiRubric
                    and danh_gia_rubric.maMucDoCL=muc_do_cl.maMucDoCL
                    AND phieu_cham.maPhieuCham=".$maPhieuCham1." GROUP by tieu_chi_rubric.maCDR_CTDT ORDER by cdr_ctdt.maCDR_CTDT_VB";
                    
               
                  
                    $ketquathongke1= db::select($sql1);
                    
                    $sql2="SELECT tieu_chi_rubric.maCDR_CTDT, cdr_ctdt.maCDR_CTDT_VB, cdr_ctdt.tenCDR_CTDT, sum(tieu_chi_rubric.trongSo) as 'Trongso',sum(danh_gia_rubric.diem) as 'diem',  COUNT(tieu_chi_rubric.maTieuChiRubric) as 'soTieuChi'
                    FROM cdr_ctdt, danh_gia_rubric, phieu_cham, tieu_chi_rubric, muc_do_cl
                    where danh_gia_rubric.maPhieuCham= phieu_cham.maPhieuCham 
                    and cdr_ctdt.maCDR_CTDT=tieu_chi_rubric.maCDR_CTDT
                    and danh_gia_rubric.maTieuChiRubric= tieu_chi_rubric.maTieuChiRubric
                    and danh_gia_rubric.maMucDoCL=muc_do_cl.maMucDoCL
                    AND phieu_cham.maPhieuCham=".$maPhieuCham2." GROUP by tieu_chi_rubric.maCDR_CTDT ORDER by cdr_ctdt.maCDR_CTDT_VB";
                    ...
                    foreach($ketquathongke1 as $kq)
                    {
                        ...
                        $kq1= $kq->diem/$kq->soTieuChi;
                        $kq2=$ketquathongke2[$chay]->diem/$ketquathongke2[$chay]->soTieuChi;                                 
                ...
                else//rubric quá trình
                {
                    ...
                    $sql="SELECT tieu_chi_rubric.maCDR_CTDT, cdr_ctdt.maCDR_CTDT_VB, cdr_ctdt.tenCDR_CTDT, sum(tieu_chi_rubric.trongSo) as 'Trongso',sum(danh_gia_rubric.diem) as 'diem',  COUNT(tieu_chi_rubric.maTieuChiRubric) as 'soTieuChi'
                    FROM cdr_ctdt, danh_gia_rubric, phieu_cham, tieu_chi_rubric, muc_do_cl
                    where danh_gia_rubric.maPhieuCham= phieu_cham.maPhieuCham 
                    and cdr_ctdt.maCDR_CTDT=tieu_chi_rubric.maCDR_CTDT
                    and danh_gia_rubric.maTieuChiRubric= tieu_chi_rubric.maTieuChiRubric
                    and danh_gia_rubric.maMucDoCL=muc_do_cl.maMucDoCL
                    AND phieu_cham.maPhieuCham=".$maPhieuCham." GROUP by tieu_chi_rubric.maCDR_CTDT ORDER by cdr_ctdt.maCDR_CTDT_VB";
    ...
    public function monhoc_ctdt($maHocPhan, $maLop)
    {
        $maSSV = session('maSSV');
